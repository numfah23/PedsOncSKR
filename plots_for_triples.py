...
subset_data.to_csv("subset_triples_final2.csv", index=False)
...
# # plt.imshow(wordcloud, interpolation='bilinear')
# # plt.axis("off")
# # plt.savefig("all_word_cloud_norm")
# # plt.show()
...
# # plt.imshow(wordcloud, interpolation='bilinear')
# # plt.axis("off")
# # plt.savefig("gs_word_cloud")
# # plt.show()

# # # # make wordcloud for subset of pmid and ct to match gs
...
# # plt.axis('off')
# # plt.savefig("gs_graph_NCT01471782")
# # plt.show()
